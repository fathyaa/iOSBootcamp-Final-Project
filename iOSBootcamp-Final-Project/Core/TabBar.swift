...
class TabBar: UITabBarController {
    ...
    func setupViewControllers() {
        ...
        // array yang berisi inisiasi VC yang akan ada di tab bar
        viewControllers = [
    ...
    // MARK: - Create Navigation Controller from Tab Bar
    /// function create navigation controller untuk pindah VC
